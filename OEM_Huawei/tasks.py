...
save_directory = os.path.join(MEDIA_ROOT, "HUAWEI_OUTPUT", "attachments")
LAST_PROCESSED_FILE = os.path.join(MEDIA_ROOT, "HUAWEI_OUTPUT", "last_mail.txt")
...
@shared_task
def outlook_mail(expected_subject="Huawei Alarm"):
...
#         unique_id = f"{mail.Subject}|{mail.SenderEmailAddress}|{mail.ReceivedTime}"

#         # check subject match
#         if expected_subject.lower() in subject.lower():

#             # already processed mail skip (IMPORTANT FIX)
#             if not is_new_mail(unique_id):
#                 print("⚠️ Already processed, skipping:", subject)
...
def process_daily_circle_logs(file_path, to_address=None, cc_mails=None):
    ...
    output_root = os.path.join(MEDIA_ROOT, "HUAWEI_OUTPUT")
    ...
    response = requests.post(
        "http://127.0.0.1:8001/oem_huawei/Huawei/",
        files=files_payload
    )
    ...
    if response.status_code == 200:
        ...
        reply_subject = "📊 Huawei Alarm Output"
        circle_mail_map = {
            
            "KK": ["Gaurav.Ranjan@ust.com", "Janardhana.Ganiga@ust.com", "Karamalla.Valli@ust.com","Samuel.Daivadeenam@ust.com","Santosh.Arsid@ust.com"],
            "ROTN": ["Berlin.JoseR@ust.com","Arunprasad.Palanisamy@ust.com", "Saravanan.Jeyaramamn@ust.com","Ajith.Thiyagarajesh@ust.com","Vinothkumar.GopalRao@ust.com","A.Hariharasudhan@ust.com"],
            "UPW": ["Dhirendra.Pandey@ust.com", "Praval.Joshi@ust.com", "Ravi.Kumar2@ust.com","Sanjay.Pandey2@ust.com","Shivam.Mittal@ust.com"],
            
            # "KK": ["Dipendra.Patel@ust.com","Vijay.Kumawat@ust.com"],
            # "ROTN": ["Dipendra.Patel@ust.com","Vijay.Kumawat@ust.com"],
            # "UPW": ["Dipendra.Patel@ust.com","Vijay.Kumawat@ust.com"],
            
            
        }

        # Root folder where circle files are saved
        huawei_output_root = os.path.join(
            MEDIA_ROOT,
            "HUAWEI_OUTPUT",
            "OUTPUT"
        )
        ...
        for circle in os.listdir(huawei_output_root):
            ...
            for file in os.listdir(circle_path):
                ...
                if file.endswith(".xlsx"):
                    ...
                    cc_mails = ';'.join([
                        ...
                        "Vineet.kumar2@ust.com",
                        "Abhishek.Sharma3@ust.com",
                        "Vijay.Kumawat@ust.com",
                        "Chandan.Prajapati@ust.com",
                        "Himanshu.Tyagi@ust.com",
                        "Harish.Singh@ust.com",
                        "Deepak.Saini@ust.com",
                        "Amit.Sahu@ust.com",
                        "Manoj.Kumar3@ust.com",
                        "Dipendra.Patel@ust.com",
                        "Shivansh.Sharma@ust.com",
