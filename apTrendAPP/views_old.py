...
def old_ap4G_trend(request):
    ...
    print("____________________", df_raw_kpi_4G)
    ...
    for item in lis:
        ...
        # print(cell_id_lis)
        if "_F3_" in item or "_F8_" in item or "_T1_" in item or "_T2_" in item:
            if "_F3_" in item:
                tech = "L1800"
    ...
    trend_wb_L900.save("22april_L900_KPI_Submission.xlsx")
