...
urlpatterns = [
    ...
    path("template/actual",views.get_excel_temp_link_actual), # 1st dash board
    path("template/projection",views.get_excel_temp_link_projected), # 1st dash board
    path("upload_report/",views.bulk_upload), # 1st dash board
    path("view-MDP-projection/",views.view_MDP_projection), # 1st dash board
    path("view-MDP-actual/",views.view_MDP_actual), # 1st dash board
