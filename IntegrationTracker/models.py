...
class Relocation_tracker(models.Model): 
    ...
    ms2= models.CharField(max_length=255, null=True)
...
class fixed_pre_traffic(models.Model):
    ...
    traffic = models.FloatField(null=True)  # Stores structured data in JSON format
...
class New_site_locked_unlocked_date(models.Model):
    ...
    purpose=models.CharField(max_length=255, null=True, blank=True , choices=(('EMF','EMF'),('SCFT','SCFT'),('MS1','MS1'),('others','others')))
    no_of_BBUs = models.CharField(max_length=255, null=True, blank=True)
    OEM = models.CharField(max_length=255, null=True, blank=True)
...
# class Relocation_Remarks(models.Model):
#     remark = models.TextField()
#     Relocation_id = models.ForeignKey(Relocation_tracker, on_delete=models.CASCADE, default=None) 
#     created_at = models.DateTimeField(auto_now_add=True)
